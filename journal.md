...
<img width="1147" height="647" alt="image" src="https://github.com/user-attachments/assets/f39f8012-7ecf-4116-8096-344d923424c4" />
...
## Week 3: Having Fun With the Launcher :D

### Day 1

I was so excited to get started working on the launcher today and have only just realised that I forgot to set up hackatime 0-0, oh well I'm sure I'll be spending a lot of time on this anyway so I'll set that up first thing tomorrow. Today I started by importing some background music, it's the background music I had on the PS4 with the Tearaway Unfolded theme and I really love how the ambience of it and it puts me in a good mood to chill and game. After I had that sorted I went to look for a background and I knew that it had to be Zelda themed - originally I was looking for a video background but I couldn't find any that were easy to loop or that I even really liked so I just went for a static image instead, I may change it though or maybe even create a menu with a few options so I can switch between them when I feel like it. I also added a little digital clock in the top right and a label at the bottom of the screen that just says "Press A to start" because it was looking a little bit empty. I spent the remainder of my time working on the row of game icons and making it so that you can hover over/switch between them as well as make it scroll when the game list grows too large for the screen. At first I created my own system for switching between icons but then I found out that Godot does it automatically if you use buttons so that's what I ended up doing. The game icons grow when hovered over and the name of the game appears above it. I made a lot of progress on the launcher today and it's definitely helping me improve my UI skills and understand the Godot UI system a lot better which is good. Tomorrow I'd like to create an icon for the game I made so I can replace the default Godot one with that, and I'll see what else I want to do to it tomorrow once I have a fresh set of eyes. Here's a screenshot of how it looks at the moment:

<img width="1151" height="646" alt="image" src="https://github.com/user-attachments/assets/0e3289c0-7360-47d7-a208-dfb07c39add8" />


### Day 3

I was feeling a bit stressed about a couple of things yesterday so I didn't end up working on my launcher but today I managed to get a bit done. I spent some time working on the game icon and imported it into Godot, I also spaced out the icons a little nicer so that they don't feel squished up at the edges of the screen. I also added the PS4 startup sound effect that plays before the ambient music just to get me in the zone for gaming and I love how chilled out I feel when turning it on. I also just realised that I forgot to set up hackatime so I'm doing that simultaneously while writing this. Next I'd like to make it so the launcher can shut down/restart the system and maybe a settings menu for different themes. I know my game looks out of place right now in the launcher next to a bunch of Godot icons that all have rounded corners but it should look nicer after I've worked on it a bit:

<img width="1152" height="646" alt="image" src="https://github.com/user-attachments/assets/c2411484-d298-45ca-8d53-fd4a36444fa5" />

### Day 7

0-0

Yeah I'm really annoyed with myself, I wanted to spend a lot of time working on my launcher but so many things took priority this week, however I could've make the launcher more of a priority. I think that unlike the first week of Console I could only think about the event and was really involved, week 2 took brought me out of the event a little and then this week I just kept forgetting about it. However, some small progress was made over the last couple days - mostly today, but what I did get done is I made a menu where you can switch out different themes which will change the background wallpaper as well as the background music so I can switch it out whever I feel like it. Currently I have Zelda, Skylanders and Tearaway themes but I do plan on definitely adding some more. I also created an icon for the themes menu and since the placeholder games are still the Godot logo I thought I'd try and blend the themes app icon with the Godot icons which helps to prevent it from standing out too much. My game still stands out quite a lot but it's definitely the most important thing on the launcher so that's alright, also after I add more games it won't be the odd one out anymore. I also added some outlines to the names of apps to help readability on the lighter backgrounds I added. Oh yeah I also made it so that the theme you choose persists through launches because that's pretty important - the theme gets saved in the config file and gets loaded when you start the launcher. I feel cosy sitting on the home screen of my launcher but also excited that I'm about to play a game which is exactly what I was going for and I'll attach a video of the launcher working below.
